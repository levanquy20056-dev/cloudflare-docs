...
Create an end-to-end data pipeline by following [this step by step guide](/r2-sql/get-started/), which showsu you how to stream events into an Apache Iceberg table and query it with R2 SQL.
